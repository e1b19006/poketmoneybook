...
INSERT INTO log(value, user_id, kind_id, type_id, date, time, status)VALUES(1500,1,1,1,'2021-11-30','12:30:10', 0);

INSERT INTO log(value, user_id, kind_id, type_id, date, time, status)VALUES(-500,2,2,4,'2022-1-1','0:34:00', 0);

INSERT INTO log(value, user_id, kind_id, type_id, date, time, status)VALUES(100,1,3,2,'2022-2-1','13:22:05', 0);
